...
import { Shield, Building2, User, Mail, Lock, Layers, Users, ArrowRight, ShieldCheck, AlertCircle } from 'lucide-react';
...
export const CreateCompanyPage: React.FC = () => {
  ...
  const [fullName, setFullName] = useState('Vikramaditya Shah');
  const [workEmail, setWorkEmail] = useState('v.shah@aplapollo.com');
  const [password, setPassword] = useState('••••••••••••');
  const [companyName, setCompanyName] = useState('APL Apollo Steel Distribution Ltd.');
  const [companyType, setCompanyType] = useState('Steel & Infrastructure Distribution');
        ...
        >
          ...
          <div className="text-center space-y-2">
            <span className="px-3 py-1 rounded-full bg-[#120F1D] border border-[#2B233D] text-[11px] font-mono text-[#CF9EFF] uppercase tracking-wider">
              PATHWAY A — COMPANY CREATION
            </span>
            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white font-sans">
              Create Your Company Account
            </h1>
            <p className="text-xs text-neutral-400 max-w-md mx-auto font-sans">
              Initialize a brand-new multi-tenant organization. As the founder, your account will be initialized with full administrative privileges.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-[#09080E]/90 backdrop-blur-xl border border-[#2B233D] p-8 sm:p-10 shadow-[0_30px_90px_rgba(0,0,0,0.9)] space-y-6 relative overflow-hidden text-left">
            ...
            {/* Informational Banner about OWNER Role */}
            <div className="p-4 rounded-2xl bg-[#14101F] border border-[#2B233D] text-xs font-sans text-neutral-300 flex items-start space-x-3">
              <ShieldCheck className="w-5 h-5 text-[#CF9EFF] shrink-0 mt-0.5" />
              <div className="space-y-1">
                <span className="font-bold text-white uppercase block font-sans">Role Assignment Rule</span>
                <p className="text-[11px] leading-relaxed text-neutral-300 font-sans">
                  The first user creating an organization is automatically assigned the <span className="text-[#CF9EFF] font-bold">OWNER</span> role. Role selection is disabled during company initialization.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4 pt-2">
                <span className="text-[11px] font-mono uppercase text-[#CF9EFF] font-bold tracking-widest block border-b border-[#1F192C] pb-1">
                  1. EXECUTIVE PROFILE
                </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-sans font-medium text-neutral-300">FULL NAME</label>
                  ...
                  {/* Work Email */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-sans font-medium text-neutral-300">WORK EMAIL</label>
                    <div className="relative">
                ...
                {/* Password */}
                <div className="space-y-1.5">
                  <label className="text-xs font-sans font-medium text-neutral-300">SECURE PASSWORD</label>
                  <div className="relative">
              ...
              <div className="space-y-4 pt-2">
                ...
                {/* Company Name */}
                <div className="space-y-1.5">
                  <label className="text-xs font-sans font-medium text-neutral-300">REGISTERED COMPANY NAME</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="e.g. APL Apollo Distribution Ltd."
                      className="w-full bg-[#12101A] border border-[#2B233D] focus:border-[#CF9EFF] rounded-xl px-3.5 py-3 pl-10 text-xs text-white placeholder-neutral-500 font-sans"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Company Type */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-sans font-medium text-neutral-300">INDUSTRY / SECTOR</label>
                    <select
                      value={companyType}
                      onChange={(e) => setCompanyType(e.target.value)}
                      className="w-full bg-[#12101A] border border-[#2B233D] focus:border-[#CF9EFF] rounded-xl px-3.5 py-3 text-xs text-white font-sans cursor-pointer"
                    >
                      <option value="Steel & Infrastructure Distribution">Steel & Infrastructure</option>
                      <option value="Manufacturing & Heavy Industry">Manufacturing</option>
                      <option value="Wholesale Distribution & Trading">Wholesale & Trading</option>
                      <option value="Logistics & Supply Chain">Logistics & Freight</option>
                  ...
                  {/* Company Size */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-sans font-medium text-neutral-300">COMPANY SIZE</label>
                    <select
                      value={companySize}
              ...
              >
                {loading ? (
                  ...
                  <>
                    <span>Initialize Company & Owner Account</span>
